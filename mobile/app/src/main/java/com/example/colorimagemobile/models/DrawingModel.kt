...
class DrawingModel {
    data class Drawing(val _id: String?, var dataUri: String, val owner: DrawingOwner, var name: String, val ownerModel: String, var privacyLevel: String, var password: String?, val createdAt: String?, val updatedAt: String?, val collaborators: ArrayList<String>?)
