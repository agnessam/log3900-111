...
data class DrawingMenuViewHolder(val name: TextView, val authorName: TextView, val drawingDate: TextView, val image: ImageView, val lockIconView: ImageView, val authorImageView: ImageView, val privacyLevel: TextView)
