...
class NewDrawingMenuBottomSheet: BottomSheetDialogFragment() {
    ...
    private fun setListeners(view: View) {
        ...
        view.findViewById<Button>(R.id.createDrawingBtn).setOnClickListener {
            if (drawingName == Constants.EMPTY_STRING || (isProtected() && drawingPassword == Constants.EMPTY_STRING) || drawingName.length < Constants.MIN_LENGTH || drawingName.length > Constants.MAX_LENGTH) {
